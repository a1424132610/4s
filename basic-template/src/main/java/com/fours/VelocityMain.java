...
//    };
    //项目路径：
    static final String jsFilePath = "E:/idea/amm/amm-web/src/main/webapp/static/js/model/";
    static final String jspFilePath = "E:/idea/amm/amm-web/src/main/webapp/WEB-INF/views/";
    static final String controllerFilePath = "E:/idea/amm/amm-web/src/main/java/com/fours/controller/";
    static final String queryFilePath = "E:/idea/amm/basic-core/src/main/java/com/fours/query/";
    static final String serviceImplFilePath = "E:/idea/amm/amm-service/src/main/java/com/fours/service/impl/";
    static final String serviceFilePath = "E:/idea/amm/amm-service/src/main/java/com/fours/service/impl/";
...
//    };
    ...
    private static List<FieldVo> scanDomain(String domainMame) throws ClassNotFoundException {
        ...
        String clazzPath="com.fours.domain."+domainMame;
