$(function () {
    ...
    menuDatagrid.datagrid({
        ...
        columns: [[
            ...
            * */
           {field: 'sn', title: '菜单编号', width: '20%',align:  'center'},
           {field: 'name', title: '菜单名称', width: '20%',align:  'center'},
           {field: 'parentId', title: '上级菜单', width: '20%',align:  'center'},
           {field: 'icon', title: '图标', width: '20%',align:  'center'},
           {field: 'url', title: '地址', width: '20%',align:  'center'},
        ]]
    });
